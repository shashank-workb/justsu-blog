...
urlpatterns = [
    ...
    path('login/', user_views.Logincustom.as_view(template_name='users/login.html'), name='login'),
    ...
    path('update-weather/', user_views.WeatherUpdate.as_view(), name='update_weather'),
]
